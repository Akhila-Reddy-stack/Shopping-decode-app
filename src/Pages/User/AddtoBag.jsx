	...
	framerating = () => {
		if (this.state.Rating === null) {
			...
			return _.fill(Array(this.state.Rating)).map((v, i) => (
				<InoIcons.IoIosStar className="stars noofstars" style={{ color: 'black' }} />
			));
		}
	};
				...
				<>
					...
					<div className="">
						...
						<div className="mobileedit-nav">
							<a href="/scan">
								{' '}
								<i class="fas fa-arrow-circle-left lefticon addbagicon"></i>
							</a>
								...
								<div>
									<Row className="feedback">
										...
										<Col md={6} className="review">
											POST A REVIEW{' '}
											<InoIcons.IoIosStar className="stars" style={{ color: 'black' }} />
										</Col>
									</Row>
								</div>
								{addedtobag && (
